...
def generate_markdown_report(data: dict) -> str:
    """Generate markdown report from threat analysis data."""
    # Existing function - keep as is
    pass

def generate_clean_report(raw_data: str) -> str:
    """Generate clean, formatted threat intelligence reports from raw data."""
...
---
*This report was automatically generated by the AI Cyber Threat Intelligence Agent. For questions or additional analysis, contact the security team.*
"""